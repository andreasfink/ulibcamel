...
-(void) MAP_Open_Req_forUser:(id<UMCamelUserProtocol>)user
                        tcap:(UMLayerTCAP *)xtcap
                       camel:(UMLayerCamel *)xcamel
                     variant:(UMTCAP_Variant)xvariant
              callingAddress:(SccpAddress *)src
               calledAddress:(SccpAddress *)dst
          applicationContext:(UMTCAP_asn1_objectIdentifier *)appContext
                    userInfo:(UMTCAP_asn1_userInformation *)xuserInfo
              userIdentifier:(UMCamelUserIdentifier *)xuserIdentifier
                     options:(NSDictionary *)xoptions
{
    
    self.logLevel = xcamel.logLevel;
    self.logFeed = xcamel.logFeed;
    if(self.logLevel <= UMLOG_DEBUG)
    {
        NSMutableString *s = [[NSMutableString alloc]initWithFormat:@"Dialog[%@]: MAP_Open_Req_forUser\n",_userDialogId.description];
    ...
    self.camelLayer = xcamel;
    self.tcapVariant = xvariant;
    ...
    UMTCAP_Transaction *t = [_tcapLayer getNewOutgoingTransactionForUserDialogId:_userDialogId user:self.camelLayer];
    self.tcapLocalTransactionId = t.localTransactionId;
    
    self.initiatedOutgoing = YES;
    self.openEstablished = NO;
    _pendingOutgoingComponents = [[UMSynchronizedArray alloc]init];
    _pendingIncomingComponents = [[UMSynchronizedArray alloc]init];
}
                     ...
                     options:(NSDictionary *)xoptions
{
    ...
    self.tcapLocalTransactionId = localTransactionId;
    ...
    {
        UMCamelUserIdentifier *uid = [_user getNewUserIdentifier];
...
-(void) MAP_Open_Resp_forUser:(id<UMCamelUserProtocol>)user
                         tcap:(UMLayerTCAP *)xtcap
                          map:(UMLayerCamel *)xgsmmap
                      variant:(UMTCAP_Variant)xvariant
               callingAddress:(SccpAddress *)src
                calledAddress:(SccpAddress *)dst
              dialoguePortion:(UMTCAP_asn1_dialoguePortion *)xdialoguePortion
                      ...
                      options:(NSDictionary *)xoptions
{
    ...
    UMCamelUserIdentifier *uid = [user getNewUserIdentifier];
    self.userIdentifier = uid;
...
- (void)MAP_ReturnError_Ind:(UMASN1Object *)params
                     opCode:(UMCamelOperation *)opcode
                   invokeId:(int64_t)invokeId
                   linkedId:(int64_t)linkedId
                  errorCode:(int64_t)errorCode
...
- (void)MAP_Reject_Ind:(UMASN1Object *)params
                opCode:(UMCamelOperation *)opcode
              invokeId:(int64_t)invokeId
              linkedId:(int64_t)linkedId
             errorCode:(int64_t)errorCode
...
- (void)MAP_Invoke_Ind:(UMASN1Object *)params
                opCode:(UMCamelOperation *)xopcode
              invokeId:(int64_t)xinvokeId
...
- (void)MAP_ReturnResult_Resp:(UMASN1Object *)params
                       opCode:(UMCamelOperation *)xopcode
                     invokeId:(int64_t)xinvokeId
                     linkedId:(int64_t)xlinkedId
                         last:(BOOL)xlast
...
- (void)MAP_ReturnError_Resp:(UMASN1Object *)params
                      opCode:(UMCamelOperation *)xopcode
                    invokeId:(int64_t)xinvokeId
                    linkedId:(int64_t)xlinkedId
...
- (void)MAP_Reject_Resp:(UMASN1Object *)params
                 opCode:(UMCamelOperation *)xopcode
               invokeId:(int64_t)xinvokeId
               linkedId:(int64_t)xlinkedId
              errorCode:(int64_t)xerrorCode
                      ...
                      willEnd:(BOOL)willEnd
{
    ...
    {
        UMCamelOperation *op = [[UMCamelOperation alloc]init];
        ...
        switch(component.asn1_tag.tagNumber)
        {
            ...
            {
                UMASN1Object *gasn1 = [[UMASN1Object alloc]initWithASN1Object:component.params context:self];
